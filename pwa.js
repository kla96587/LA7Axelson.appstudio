...
const cacheName = 'LA7Axelson-2021-03-21 13:25:26.718797'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA7Axelson'.length) === 'LA7Axelson') {
